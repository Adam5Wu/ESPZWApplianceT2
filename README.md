...
| Lower-level framework                    | ESP8266-Arduino   | **ESP8266 RTOS SDK**                 |
...
You can create as many forks and derivations as compliant with the license of this project!

However, note that **GitHub** only allows you to create *ONE* "official" fork for each project. So avoid building your appliances **directly in** the repo you created using the "Fork" button.

Instead, create *local* Git repo clones for *each* of your appliance projects based on your forked ESPZWApplianceT2 repo (and push to GitHub as new projects, if you'd like to). I found a [nice step-by-step guide here](https://handong1587.github.io/linux_study/2015/12/18/create-multi-forks.html).

## How to Create Appliance

1. Install VSCode and PlatformIO extension, if you don't have them already;
2. Open the project root folder, wait for PlatformIO install all dependencies;
3. Off you go! (No, really! You are ready!)
